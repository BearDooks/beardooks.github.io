...
image: ![bitbucket_commits]({{ "/img/ bitbucket_commits.jpg" | absolute_url }})
...
image: ![trello_cards]({{ "/img/trello_cards.jpg" | absolute_url }})
...
image: ![slack_git]({{ "/img/slack_git.jpg" | absolute_url }})
image: ![slack_code]({{ "/img/slack_code.jpg" | absolute_url }})
